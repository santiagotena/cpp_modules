...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/22 22:55:31 by stena-he          #+#    #+#             */
/*   Updated: 2023/05/22 22:55:43 by stena-he         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (_hitPoints <= 0)
		std::cout << _name << " has fainted." << std::endl;
	return ;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << _name << " repairs itself. It recovered " << \
